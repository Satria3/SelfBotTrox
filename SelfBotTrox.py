...
satria = LINETCR.LINE() 
satria.login(token="Eqek1vC7KLnK4jsWnYb0.fGIUiExEjuE1/OChSHYIia.I+U46H+FbaNeyUFj6q8tYpNBQ7cKfoHlCQ972Cv50fg=")
satria.loginResult()
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""❂•••AUTO ADD BY BOTTROX BOT••••❂\nhttps://github.com/satria3/BotTroxSelfBot\n❂•••••••❂""",
    "lang":"JP",
    "comment1":"❂•••AUTO ADD BY BOTTROX BOT••••❂\nhttps://github.com/satria3/BotTroxSelfBot\n❂•••••••❂",
            ...
            if msg.contentType == 13:
                if wait["wblack"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        try:
                            cu = satria.channel.getCover(msg.contentMetadata["mid"])
                        except:
                            cu = ""
...
#                else:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    satria.sendText(msg.to,"􀜁􀇔􏿿semua nama  telah di update menjadi\n👉 " + string + "👈")
...
#--------------------------------------------------------
                ...
                if wait["contact"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        satria.sendText(msg.to,"already Close ô€œô€„‰👈")
                ...
                if wait["protect"] == True:
                    ...
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        satria.sendText(msg.to,"Protection Enable􀜁􀇔􏿿")
                    else:
                ...
                blockedlist = satria.getBlockedContactIds()
                ...
                msg.contentMetadata = {'mid': 'u1608ae21e5de2547b5fa8707b21ca220'}
                satria.sendMessage(msg)
                satria.sendText(msg.to,"🇲🇨•••••{CREATOR BOTTROX BOT}•••••🇲🇨")
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)
                if wait["lang"] == "JP":
                    satria.sendText(msg.to,"BOTTOX Sudah Keluar Di semua grup")
                else:
...
#-------------------------------------------------
	      ...
	      if msg.from_ in admin:
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
		       satria.sendText(msg.to,"Wating in progres...\nhttps://github.com/Satria3/BotTroxProtect")
                       satria.sendText(g.mid,"https://github.com/Satria3/BotTroxProtect")
                       pb1.sendText(g.mid,"https://github.com/Satria3/BotTroxProtect")
                       pb2.sendText(g.mid,"https://github.com/Satria3/BotTroxProtect")
                       satria.sendText(g.mid,"https://github.com/Satria3/BotTroxProtect")
                       pb1.sendText(g.mid,"https://github.com/Satria3/BotTroxProtect")
                       pb2.sendText(g.mid,"https://github.com/Satria3/BotTroxProtect")
                       pb1.sendText(g.mid,"https://github.com/Satria3/BotTroxProtect")
...
#-----------------------------------------------------------speed
                ...
                if wait["blacklist"] == {}:
                    ...
                    for mi_d in wait["blacklist"]:
                        mc += "�" +sqtria.getContact(mi_d).displayName + "\n"
                    satria.sendText(msg.to,mc)
...
#---------------------------------------------------
                    ...
                    try:
                       ...
                       satrial.sendText(msg.to, "Telah kembali semula")
...
#---------------------- = NUKE = ------------------
                ...
                if msg.toType == 2:
                    ...
                    satria.sendText(msg.to,"https://github.com/Satria3/BotTroxProtect")
                    targets = []
                    for g in gs.members:
...
#			    random.choice(KAK).kickoutFromGroup(op.param1,[op.param2])
	...
	if op.type == 13:
		...
		if op.param2 in Bots:
		    ...
		    wait ["blacklist"][op.param2] = True
		    satria.cancelGroupInvitation(op.param1,[contact.mid for contact in acil.getGroup(op.param1).invitee])
		else:
		    satria.sendText(op.param1,"")
	    else:
		satria.sendText(op.param1,"")
